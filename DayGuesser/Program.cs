...
namespace DayGuesser
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //Ask our user for their date of birth
            var usersDateOfBirth = AskForDateOfBirth();

            //Announce information about the date
        ...
        /// <summary>
        /// Introduce Savvy our robot to our user
        /// </summary>
        ...
        /// <summary>
        /// Ask the user for their date of birth, untill it is given in a correct format.
        /// </summary>
        /// <remarks>
        ...
        {
            //Create checked date with initial out of value
            ...
            while (dateOfBirth > DateTimeOffset.UtcNow)
            {
               ...
               $"what your date of birth is? {CultureInfo.CurrentCulture.DateTimeFormat.ShortDatePattern}");
                ...
                //Otherwise......
                    ...
                    //Inform the user they entered an invalid date
        ...
        /// <summary>
        /// Displaying information to the user about the given date of birth
        /// <summary/>
